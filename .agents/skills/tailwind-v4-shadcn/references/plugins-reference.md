...
**Why it breaks in many v4 setups**: In CSS-first projects, this config-only plugin approach is often not loaded unless you're explicitly using compatibility directives (`@config`/legacy config flow).
...
- Tailwind v4 Functions & Directives (`@plugin`, `@config`): https://tailwindcss.com/docs/functions-and-directives
