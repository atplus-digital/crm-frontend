...
- `--claude-shim` - ~~Generate CLAUDE.md~~ **Do not use** — this project maintains only AGENTS.md
- `--symlinks` - ~~Create CLAUDE.md and GEMINI.md symlinks~~ **Do not use** — this project does not create agent-specific symlinks; AGENTS.md is the single source of truth
