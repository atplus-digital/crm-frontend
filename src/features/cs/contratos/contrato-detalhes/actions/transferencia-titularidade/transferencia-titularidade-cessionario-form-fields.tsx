		...
		<div className="grid grid-cols-2 gap-3">
			<div className="space-y-1.5">
				...
				<Input
					...
					className={cn(tipoPessoa === "PF" && "bg-muted/50")}
				/>
			...
			<div className="space-y-1.5">
				<Label htmlFor="f_cessionario_documento">
...
function ContactFields({
	...
	return (
		<div className="grid grid-cols-3 gap-3">
			<div className="space-y-1.5">
				<Label htmlFor="f_cessionario_responsavel">Responsável Legal</Label>
				<Input
			...
			<div className="space-y-1.5">
				<Label htmlFor="f_cessionario_telefone">
			...
			<div className="space-y-1.5">
				<Label htmlFor="f_cessionario_email">
