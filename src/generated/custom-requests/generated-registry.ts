...
export const generatedCustomRequestsRegistry = {
	...
	"6ke3hsmki23": {
		...
		payloadSchema: z.object({
			f_fk_negociacao_vendedor: z.string(),
			f_cep: z.string(),
			f_endereco: z.string(),
			...
			f_fk_pessoa_negociacao: z.string(),
		}),
		payloadData: {
	...
	"8e9nkpsadjm": {
		...
		payloadSchema: z.object({
			...
			wpp_assinatura: z.string(),
			email_assinatura: z.string(),
			nome: z.string(),
			cpf: z.string(),
		}),
		payloadData: {
	...
	b186501hwq6: {
		...
		payloadSchema: z.object({
			"Tipo de atendimento": z.string(),
			"Nome do solicitante": z.string(),
			"Protocolo do atendimento": z.string(),
			LOS: z.string(),
			"Quantidade de dispositivos": z.string(),
			"Tipo de conexão do dispositivo": z.string(),
			"Aplicativo específico": z.string(),
			Aplicativo: z.string(),
			"Login PPPoE": z.string(),
			"IP Fixo": z.string(),
			"Portas a serem liberadas": z.string(),
			"IP interno para liberação": z.string(),
			"Endereço do site": z.string(),
			"Acessa rela rede ATPlus": z.string(),
			"Alterações a serem realizadas": z.string(),
			"Nome da rede": z.string(),
			"Senha da rede": z.string(),
			"Tipo de problema": z.string(),
			"Número de A": z.string(),
			"Número de B": z.string(),
			"Status do registro": z.string(),
			"Número para contato": z.string(),
			Observação: z.string(),
			finaliza: z.string(),
			tarefa: z.string(),
			datainicio: z.string(),
			...
			endereco: z.string(),
			usuário: z.string(),
			"melhor horário": z.string(),
			"tipo de problema MVNO": z.string(),
			fabricante: z.string(),
			"qual fabricante": z.string(),
			"APN preenchida": z.string(),
			"qual APN": z.string(),
			"torre de rede": z.string(),
			"aplicativos sva": z.string(),
			"endereço e-mail": z.string(),
			"tarefa descrição": z.string(),
		}),
		payloadData: {
			"Tipo de atendimento":
	...
	ghcsm5m6cb8: {
		...
		payloadSchema: z.object({
			fk_funcionarios: z.string(),
			nome_patrimonio: z.string(),
	...
	im5okkvu9dz: {
		...
		payloadSchema: z.object({
			...
			origem_endereco_estrutura: z.string(),
			endereco: z.string(),
			latitude: z.string(),
			longitude: z.string(),
			id_wfl_processo: z.string(),
			id_ticket_setor: z.string(),
			id_responsavel_tecnico: z.string(),
			data_criacao: z.string(),
			data_ultima_alteracao: z.string(),
			prioridade: z.string(),
			data_reservada: z.string(),
			melhor_horario_reserva: z.string(),
			id_ticket_origem: z.string(),
			id_usuarios: z.string(),
			id_resposta: z.string(),
			menssagem: z.string(),
			interacao_pendente: z.string(),
			su_status: z.string(),
			id_evento_status_processo: z.string(),
			id_canal_atendimento: z.string(),
			status: z.string(),
			mensagens_nao_lida_cli: z.string(),
			mensagens_nao_lida_sup: z.string(),
			token: z.string(),
			finalizar_atendimento: z.string(),
			id_su_diagnostico: z.string(),
			status_sla: z.string(),
			origem_cadastro: z.string(),
			ultima_atualizacao: z.string(),
			cliente_fone: z.string(),
			cliente_telefone_comercial: z.string(),
			cliente_id_operadora_celular: z.string(),
			cliente_telefone_celular: z.string(),
			cliente_whatsapp: z.string(),
			cliente_ramal: z.string(),
			cliente_email: z.string(),
			cliente_contato: z.string(),
			cliente_website: z.string(),
			cliente_skype: z.string(),
			cliente_facebook: z.string(),
			latitude_cli: z.string(),
			longitude_cli: z.string(),
			latitude_login: z.string(),
			longitude_login: z.string(),
		}),
		payloadData: {
			tipo: "C",
			id_estrutura: "",
	...
	qbk10nf76um: {
		...
		name: "qbk10nf76um",
		collection: "t_logs",
		options: { method: "POST", url: "http://localhost:4000" },
		payloadSchema: z.object({
			model: z.string(),
		}),
		payloadData: {
