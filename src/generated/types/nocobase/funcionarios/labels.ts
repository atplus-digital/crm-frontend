...
// ============================================================
export const FFUNCIONARIOS_FIELD_LABELS = {
	createdAt: "Criado em",
	createdBy: "Criado por",
	createdById: "createdById",
	f_aniversarios: "Aniversários",
	f_arquivos_funcionarios: "Arquivos Funcionários",
	f_asos: "ASOS",
	f_ativo: "Ativo",
	f_bairro: "Bairro",
	f_cargo: "Cargo",
	f_celular: "Celular",
	f_cep: "CEP",
	f_checklist_admissional: "Checklist Admissional",
	f_chip_corporativo: "Chip Corporativo",
	f_cnh: "CNH",
	f_cnpj: "CNPJ",
	f_conta_salario_pix: "Conta Salário / PIX",
	f_cpf: "CPF",
	f_curso: "Curso",
	f_data_admissao: "Data Admissão",
	f_data_demissao: "Data Demissão",
	f_data_nascimento: "Data Nascimento",
	f_departamento: "Departamento",
	f_email_corporativo: "Email Corporativo",
	f_email_pessoal: "Email Pessoal",
	f_empresa: "Empresa",
	f_endereco: "Endereço",
	f_endereco_cidade: "Cidade",
	f_endereco_cnpj: "Endereço (Terceiro)",
	...
	f_epi_calca: "Tamanho EPI - Calça",
	f_epi_calcado: "Tamanho EPI - Calçado",
	f_epi_jaleco: "Tamanho EPI - Jaleco",
	f_escolaridade: "Escolaridade",
	f_estado_civil: "Estado Civil",
	f_fk_funcionarios: "f_fk_funcionarios",
	f_fk_funcionarios2: "f_fk_funcionarios2",
	f_fk_setor: "f_fk_setor",
	f_fk_turnos: "f_fk_turnos",
	f_foto_funcionarios: "Foto",
	f_genero: "Gênero",
	f_id_tecnico_ixc: "ID Técnico IXC",
	f_info_arquivos: "Informação dos Arquivos (Funcionários)",
	f_info_aso: "Informação do ASO",
	f_logs_cargos: "LOGs Cargos",
	f_mes_nascimento: "Mês de Nascimento",
	f_mobilidade: "Opção Mobilidade",
	f_motivo_demissao: "Motivo da Demissão",
	f_nacionalidade: "Nacionalidade",
	f_naturalidade: "Naturalidade",
	f_nome: "Nome",
	f_nome_contato_emergencia: "Nome do Contato de Emergência",
	f_orgao_expedidor: "Órgão Expedidor",
	f_parentesco: "Parentesco",
	f_patrimonio_funcionarios: "Patrimônio Funcionários",
	f_pcd: "PCD",
	f_periodos_ferias: "Períodos de Férias",
	f_prazo_experiencia: "Prazo de Experiência",
	f_qualirun_processos: "QualiRun - Processos",
	f_razao_social: "Razão Social",
	f_reservista: "Reservista",
	f_rg: "RG",
	f_secao_eleitoral: "Seção Eleitoral",
	f_situacao_escolaridade: "Situação Escolaridade",
	f_telefone_emergencia: "Telefone de Emergência",
	f_terceiro: "Terceiro",
	f_tipo_contrato: "Tipo de Contrato",
	f_tipo_deficiencia: "Tipo de Deficiência",
	f_titulo_eleitor: "Título de Eleitor",
	f_turnos: "Turnos",
	f_unidade: "Unidade",
	f_universidade: "Universidade",
	f_valor_rescisao: "Valor da Rescisão",
	f_vencimento_contrato: "Vencimento Contrato",
	f_vinculo_com_colaborador: "Vínculo com o Colaborador",
	f_zona_eleitoral: "Zona Eleitoral",
	id: "ID",
