...
export const fn_areceberRelationSchema = z.object({
	...
	f_conta_class_finan: z.number().nullable(),
	f_conta_class_finan_a: z.number().nullable(),
	f_contas: z.number().nullable(),
	f_contrato: z.lazy(() => cliente_contratoBaseSchema.nullable()),
	f_contrato_avulso: z.lazy(() => cliente_contratoBaseSchema.nullable()),
	f_filial: z.number().nullable(),
	f_lote_geracao_financeiro_fatura: z.number().nullable(),
	f_mot_cancelamento: z.number().nullable(),
	f_nf_gerada: z.number().nullable(),
	f_nf_opcional2: z.number().nullable(),
	f_nf_opcional3: z.number().nullable(),
	f_nf_opcional4: z.number().nullable(),
...
export const fn_areceberCreateSchema = fn_areceberSchema.omit({
	...
	f_cliente: true,
	f_conta: true,
	f_conta_class_finan: true,
	f_conta_class_finan_a: true,
	f_contas: true,
	f_contrato: true,
	f_contrato_avulso: true,
	f_filial: true,
	f_lote_geracao_financeiro_fatura: true,
	f_mot_cancelamento: true,
	f_nf_gerada: true,
	f_nf_opcional2: true,
	f_nf_opcional3: true,
	f_nf_opcional4: true,
