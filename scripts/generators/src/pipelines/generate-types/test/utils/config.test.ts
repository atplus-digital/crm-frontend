import type { ScriptConfig } from "@scripts/generators/src/pipelines/generate-types/@types/script";
import { parseConfig } from "@scripts/generators/src/pipelines/generate-types/utils/config";
...
vi.mock(
	"@scripts/generators/src/pipelines/generate-types/utils/load-config",
	() => ({
