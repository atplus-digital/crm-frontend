...
import { config } from "@scripts/generators/generate-types/config";
import type { MultiFileResult } from "@scripts/generators/generate-types/src/@types/script";
import { toFileName } from "@scripts/generators/generate-types/src/utils/naming";
import { logger } from "@scripts/generators/shared/lib/logger";
import { validateTypeScriptDirectory } from "@scripts/generators/shared/lib/tsc-validator";
