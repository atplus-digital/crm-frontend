import type { RelationInfo } from "@scripts/generators/generate-types/src/@types/generation";
import type { DataSourceField } from "@scripts/generators/generate-types/src/@types/script";
