import type {
	...
	GeneratedTypes,
	RelationInfo,
} from "@scripts/generators/generate-types/src/@types/generation";
import type { NocoBaseField } from "@scripts/generators/generate-types/src/@types/nocobase";
import type { RuntimeConfig } from "@scripts/generators/generate-types/src/@types/script";
...
vi.mock("@scripts/generators/generate-types/config", () => ({
	get config() {
