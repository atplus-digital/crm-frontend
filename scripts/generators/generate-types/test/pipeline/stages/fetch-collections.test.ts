import type { DataSourceClient } from "@scripts/generators/generate-types/src/@types/script";
import type { InitContext } from "@scripts/generators/generate-types/src/pipeline/core/types";
	...
	describe("NocoBase - sempre busca da API", () => {
		it("deve buscar TODAS as collections da API para datasource nocobase", async () => {
			const { fetchCollections } = await import(
				"@scripts/generators/generate-types/src/pipeline/stages/fetch-collections"
			);
