...
import {
	...
	generateFileHeader,
	generateSplitFiles,
} from "@scripts/generators/generate-types/src/pipeline/stages/generate-content/content";
	...
	describe("generateEnumDefinition", () => {
		it("generates type alias with keyof typeof", async () => {
			const { generateEnumDefinition } = await import(
				"@scripts/generators/generate-types/src/pipeline/stages/generate-content/content"
			);
