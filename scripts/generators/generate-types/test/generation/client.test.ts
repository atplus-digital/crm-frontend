import type { NocoBaseCredentials } from "@scripts/generators/generate-types/src/@types/nocobase";
import { NocoBaseDataSourceClient } from "@scripts/generators/generate-types/src/utils/client";
