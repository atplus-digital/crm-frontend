import {
	extractRelationInfo,
	mapFieldType,
} from "@scripts/generators/generate-types/src/pipeline/stages/generate-content/field-mapper";
import { createMockField } from "@scripts/generators/generate-types/test/setup";
