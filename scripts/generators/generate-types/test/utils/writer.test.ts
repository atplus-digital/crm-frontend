...
import {
	...
	writeGeneratedFile,
	writeMultipleFiles,
} from "@scripts/generators/generate-types/src/pipeline/post-pipeline/writer";
...
vi.mock(
	"@scripts/generators/generate-types/src/pipeline/post-pipeline/file-editor-check",
	() => ({
...
vi.mock("@scripts/generators/generate-types/src/utils/naming", () => ({
