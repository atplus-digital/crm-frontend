import type { ScriptConfig } from "@scripts/generators/generate-types/src/@types/script";
import { parseConfig } from "@scripts/generators/generate-types/src/utils/config";
...
vi.mock("@scripts/generators/generate-types/src/utils/load-config", () => ({
