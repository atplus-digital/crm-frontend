import { splitCollectionsByConfig } from "@scripts/generators/generate-types/src/pipeline/stages/split-collections/collection-splitter";
import { createMockCollectionTypesMap } from "@scripts/generators/generate-types/test/setup";
