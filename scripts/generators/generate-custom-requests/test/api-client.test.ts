import type { ScriptConfig } from "@scripts/generators/generate-custom-requests/src/@types/script-config";
import { CustomRequestsApiClient } from "@scripts/generators/generate-custom-requests/src/api/client";
